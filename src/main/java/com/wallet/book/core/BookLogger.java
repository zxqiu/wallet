...
public class BookLogger {
    ...
    public static void addBookEntry(String user_id, String book_id, String book_group_id, String book_entry_id
            , String book_entry_group_id, String category_id, String category_group_id, BookLog.BOOK_LOG_NOTE note) throws Exception {
        log(user_id, book_id, book_group_id, book_entry_id, book_entry_group_id, category_id, category_group_id
                , BookLog.BOOK_LOG_OPERATION.ADD, BookLog.BOOK_LOG_TYPE.BOOK_ENTRY, note);
    }

    public static void deleteBookEntry(String user_id, String book_id, String book_group_id, String book_entry_id
            , String book_entry_group_id, String category_id, String category_group_id, BookLog.BOOK_LOG_NOTE note) throws Exception {
        log(user_id, book_id, book_group_id, book_entry_id, book_entry_group_id, category_id, category_group_id
                , BookLog.BOOK_LOG_OPERATION.DELETE, BookLog.BOOK_LOG_TYPE.BOOK_ENTRY, note);
    }

    public static void updateBookEntry(String user_id, String book_id, String book_group_id, String book_entry_id
            , String book_entry_group_id, String category_id, String category_group_id, BookLog.BOOK_LOG_NOTE note) throws Exception {
        log(user_id, book_id, book_group_id, book_entry_id, book_entry_group_id, category_id, category_group_id
